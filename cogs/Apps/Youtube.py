...
async def youtube(self, ctx, query):
	...
	embeds=[]
	params={'part':'snippet', 'maxResults':15, 'q':query, 'key':vars.youtube_key, 'safeSearch':'none' if ctx.channel.is_nsfw() else 'strict'}
	...
	for item in r['items']:
		...
		embed= discord.Embed(color=vars.Youtube[2])
		embed.set_author(name='Youtube Search', icon_url=vars.Youtube[1])
